...
<section class="section">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Form Input Data Kelurahan</h4>
        </div>
        <div class="card-body">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form" action="{{ route('kelurahan.store') }}" method="post">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-md-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="nama_kelurahan" class="form-control @error('nama_kelurahan') is-invalid @enderror"
                                                        placeholder="Silahkan Isi Nama Kelurahan.." name="nama_kelurahan" value="{{ old('nama_kelurahan') }}" required>
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <input type="text" id="nama_kecamatan" class="form-control @error('nama_kecamatan') is-invalid @enderror"
                                                      placeholder="Silahkan Isi Nama Kecamatan.." name="nama_kecamatan" value="{{ old('nama_kecamatan') }}" required>
                                              ...
                                              <div class="form-group">
                                                ...
                                                <input type="text" id="nama_kota" class="form-control @error('nama_kota') is-invalid @enderror"
                                                    placeholder="Silahkan Isi Nama Kota.." name="nama_kota" value="{{ old('nama_kota') }}" required>
