                                            ...
                                            <div class="col-md-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="id" class="form-control @error('id') is-invalid @enderror"
                                                        placeholder="ID akan terisi otomatis" name="id" value="{{ $auto_number }}" required disabled>
                                                    <input type="hidden" id="id_pasien" name="id_pasien" value="{{ $auto_number }}">
                                                    @if($errors->has('id'))
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="nama" class="form-control @error('nama') is-invalid @enderror"
                                                        placeholder="Silahkan Isi Nama Pasien.." name="nama" value="{{ old('nama') }}" required>
                                                    @if($errors->has('nama'))
                                                      <span class="invalid-feedback" role="alert">
                                                ...
                                                <div class="form-group">
                                                  <div class="col-sm-6">
                                                    ...
                                                    <input type="text" id="rt" class="form-control @error('rt') is-invalid @enderror"
                                                        placeholder="ex : 02.." name="rt" value="{{ old('rt') }}" required>
                                                    @if($errors->has('rt'))
                                                      <span class="invalid-feedback" role="alert">
                                                  ...
                                                  <div class="col-sm-6">
                                                    ...
                                                    <input type="text" id="rw" class="form-control @error('rw') is-invalid @enderror"
                                                        placeholder="ex : 02.." name="rw" value="{{ old('rw') }}" required>
                                                    @if($errors->has('rw'))
                                                      <span class="invalid-feedback" role="alert">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <select name="kelurahan_id" id="kelurahan_id" class="form-control @error('rw') is-invalid @enderror" required>
                                                  ...
                                                  @foreach ($kelurahan as $m)
                                                      <option value="{{ $m->id }}">{{$m->nama_kelurahan}}</option>
                                                  @endforeach
                                                </select>
                                              ...
                                              <div class="form-group">
                                                ...
                                                <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" id="tanggal_lahir"  name="tanggal_lahir" required
                                                 placeholder="Masukkan tanggal lahir pasien..." value="{{ old('tanggal_lahir') }}">
